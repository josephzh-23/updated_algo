...
# Here we would be inserting the tree here as a start as said before multiple times
...
def walkTrie(root):
    ...
    while(countChildren(pCrawl) == 1 and pCrawl.isLeaf == False):
        # this will then keep traversing here
        pCrawl = pCrawl.children[indexs]

        # the indexes here would be the index of the letter here and there
