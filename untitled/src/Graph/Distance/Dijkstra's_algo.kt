...
// Can then find the path with the shortest cost here
class GFG(private val V: Int) {
    ...
    companion object {
        ...
        fun main(arg: Array<String>) {
            ...
            for (i in dpq.dist.indices) println(source.toString() + " to " + i + " is "
                    + dpq.dist[i])
        }
    }
}
