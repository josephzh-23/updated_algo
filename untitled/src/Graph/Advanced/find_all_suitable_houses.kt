...
https://leetcode.com/discuss/interview-question/1429168/american-express-oa-2021-india

Given a rectangular grid containing houses built in some cells,
find the number of empty cells at a distance of at most K to every house.
 */
/*
Step 1:
...
fun main() {
    ...
    var s = Graph.Hard.Solution4(houseGrid)
